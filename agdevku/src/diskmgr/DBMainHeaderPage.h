...
public:
	 ...
	 */
	static STATUS_CODE createHeaderPage(int pageSize,char *pageData,int pageNumber,int numOfPages);
	...
	void updateSysIndexColumnsHeaderPageNumber(int sysIndexColumnsHeaderPageNumber);
