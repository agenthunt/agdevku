...
public:
	...
	static void getInitialSysColSchema(Schema& schema) {
		...
		str << "SYSCOL,5," << "COL_ID," << Util::int_to_string(TYPE_INTEGER)
				<< "," << Util::int_to_string(INTEGER_LENGTH) << ","
				<< "COL_NAME," << Util::int_to_string(TYPE_VARCHAR) << ","
	...
	static void getInitialSysIndexSchema(Schema& schema) {
		std::stringstream str;
		str << "SYSINDEX,5," << "INDEX_ID,"	<< Util::int_to_string(TYPE_INTEGER) << ","
				<< Util::int_to_string(INTEGER_LENGTH)
		<< "," << "INDEX_NAME,"	<< Util::int_to_string(TYPE_VARCHAR) << ","<< Util::int_to_string(DEFAULT_LENGTH) << ","
		<< "NO_OF_COLS,"<< Util::int_to_string(TYPE_INTEGER) << ","	<< Util::int_to_string(INTEGER_LENGTH) << ","
				<< "INDEX_HDR_PG_NO," << Util::int_to_string(TYPE_INTEGER)
				<< "," << Util::int_to_string(INTEGER_LENGTH) << ","
				<< "TAB_ID," << Util::int_to_string(TYPE_INTEGER) << ","
				<< Util::int_to_string(INTEGER_LENGTH);

		schema.prepareSchemaObj(str.str());
	}

	static void getInitialSysIndexColSchema(Schema& schema) {
		std::stringstream str;
		str << "SYSINDEXCOL,3," << "INDEX_COL_ID," << Util::int_to_string(
				TYPE_INTEGER) << "," << Util::int_to_string(INTEGER_LENGTH)
				<< "," << "INDEX_ID," << Util::int_to_string(TYPE_INTEGER)
				<< "," << Util::int_to_string(INTEGER_LENGTH) << ","
				<< "SYS_COL_ID," << Util::int_to_string(TYPE_INTEGER) << ","
				<< Util::int_to_string(INTEGER_LENGTH);
		schema.prepareSchemaObj(str.str());
	}
