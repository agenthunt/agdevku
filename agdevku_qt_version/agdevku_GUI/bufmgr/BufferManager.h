...
public:
	...
	std::vector<std::string> getListOfDatabases();
	STATUS_CODE getPageNumber(int frameNumber, int& pageNumber);
	...
	int numOfDiskAccess_;
	int numOfPageReads_;
	int numOfTimesPageFoundInBuffer_;
	int totalNumOfRequestsToBuffer_;
